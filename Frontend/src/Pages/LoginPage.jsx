    ...
    return (
        <>
            <div className="w-full h-[100vh] flex flex-col items-center justify-center">
                <form className="md:w-96 w-80 flex flex-col items-center justify-center bg-black/5 p-8 rounded-2xl">
                    <h2 className="text-4xl text-indigo-500 font-medium mb-5">User <span className='text-gray-800'>Login</span></h2>
